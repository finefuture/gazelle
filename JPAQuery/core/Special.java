...
public class Special extends CommonCriteriaExpression {
    ...
    public Special(Jpa jpa) {
        super(jpa.cb());
        this.jpa = jpa;
        this.specStructure = new SpecStructure();
    }

    public Special(Jpa jpa, TupleBuilder tupleBuilder) {
        super(jpa.cb());
        this.jpa = jpa;
    ...
    public TupleBuilder build () {
        return this.tupleBuilder;
    }

    public List<Expression> expressions () {
        return specStructure.getExpressions();
    }

    public List<Expression> groupBy () {
        return specStructure.getGroupBy();
    }

    public List<String> alias () {
        return specStructure.getAlias();
    }
    ...
    public Special all () {
        ...
        SpecStructure specStructure = this.specStructure;
    ...
    public Special count (String field, String alias) {
        ...
        specStructure.addExpAndAlias(count, alias);
        return this;
    }
    ...
    public Special sum (String field, String alias) {
        ...
        specStructure.addExpAndAlias(sum, alias);
        return this;
    }
    ...
    public Special nullif (String field, Object val, String alias) {
        ...
        specStructure.addExpAndAlias(nullif, alias);
        return this;
    }
...
//    }
    ...
    public Special avg (String field, String alias) {
        ...
        specStructure.addExpAndAlias(avg, alias);
        return this;
    }
    ...
    public Special max (String field, String alias) {
        ...
        specStructure.addExpAndAlias(max, alias);
        return this;
    }
    ...
    public Special trim (String field, String alias) {
        ...
        specStructure.addExpAndAlias(trim, alias);
        return this;
    }
    ...
    public Special min (String field, String alias) {
        ...
        specStructure.addExpAndAlias(min, alias);
        return this;
    }
    ...
    public Special upper (String field, String alias) {
        ...
        specStructure.addExpAndAlias(upper, alias);
        return this;
    }
    ...
    public Special lower (String field, String alias) {
        ...
        specStructure.addExpAndAlias(lower, alias);
        return this;
    }
    ...
    public Special subString (String field, int start, String alias) {
        ...
        specStructure.addExpAndAlias(substring, alias);
        return this;
    }
    ...
    public Special concat (String field1, String field2, String alias) {
        ...
        specStructure.addExpAndAlias(concat, alias);
        return this;
    }
